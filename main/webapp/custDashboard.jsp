...
<%@ page import="bankingApp.Transaction"%>
							...
							<div class="transaction">
								<div class="trans-container">
									...
									<div class="trans-info">
										<div class="history">
											<%
											List<Transaction> recentTransactions = (List<Transaction>) session.getAttribute("recentTransactions");
											if (recentTransactions != null && !recentTransactions.isEmpty()) {
												for (Transaction transaction : recentTransactions) {
											%>
											<div class="element">
												<p>
													<span class="reason"><%=transaction.getType()%></span><span
														class="flash"><img
														src="<%=transaction.getType().equals("Deposit") ? "pics/down.svg" : "pics/up.svg"%>"
														alt="" /></span>
												</p>
												<p>
													<span class="date"><%=transaction.getDate()%></span><span
														class="money"><%=transaction.getAmount()%> <span
														style="color: green">Rs.</span></span>
												</p>
												<hr />
											</div>
											<%
										...
										<div style="text-align: center; margin: 20px;">
											<a href="DownloadRecentTransactionsServlet">Download
