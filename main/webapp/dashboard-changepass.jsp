...
<body>
											...
											<div class="online-password">
												<form action="ChangePasswordServlet" method="post">
													<label for="accNo">Account number</label> <input
														...
														required readonly /> <label for="pin">Enter New
														Password</label> <input type="number" id="pin" name="pin" required />
													<label for="pin1">Confirm Password</label> <input
														type="number" id="pin1" name="pin1" required />
	...
	<script src="js/dashboard-js.js" defer></script>
</body>
</html>